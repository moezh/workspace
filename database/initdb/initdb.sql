...
('profile_job_title','Senior Software Engineer'),
...
('skill_group2_summary','Typescript,NodeJs,ExpressJs,PostgreSQL,RESTful APIs'),
('skill_group3_title','Infrastructure'),
('skill_group3_summary','Git,Docker,Linux'),
...
('projects_footer_link','blog,store'),
