...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const result = await fetch("http://backend:3001/api/home/tos", {
    headers: {
...
export default function Page(props: { data: { profile_name: string } }) {
  return (
    <>
      <Head
        ...
        <div className="pt-8">
          <div className="w-full">
            ...
            <p>
              ...
              {props.data.profile_name}. We offer this website, including all
            ...
            <p>
              ...
              inaccuracies or omissions, and to schange or update information or
            ...
            <p>
              ...
              case shall we, our directors, officers, employees, affiliates,
