      ...
      <div className="w-full pt-4">
        ...
        <div className="pt-8">
          <div className="w-full">
            ...
            <p className="uppercase pt-6">Personal Data</p>
            <p>
            ...
            <p className="uppercase pt-6">Derivative Data</p>
            <p>
            ...
            <p className="uppercase pt-6">Financial Data</p>
            <p>
            ...
            <p className="uppercase pt-6">Facebook Permissions</p>
            <p>
            ...
            <p className="uppercase pt-6">Data from Social Networks</p>
            <p>
              User information from social networking sites, including your
            ...
            <p className="uppercase pt-6">Geo-Location Information</p>
            <p>
            ...
            <p className="uppercase pt-6">Mobile Device Access</p>
            <p>
              We may request access or permission to certain features from your
              mobile device, including your mobile device's. If you wish to
              change our access or permissions, you may do so in your device's
              settings.
            </p>
            <p className="uppercase pt-6">Mobile Device Data</p>
            <p>
            ...
            <p className="uppercase pt-6">Push Notifications</p>
            <p>
            ...
            <p className="uppercase pt-6">Third-Party Data</p>
            <p>
            ...
            <p className="uppercase pt-6">By Law or to Protect Rights</p>
            <p>
            ...
            <p className="uppercase pt-6">Third-Party Service Providers</p>
            <p>
            ...
            <p className="uppercase pt-6">Marketing Communications</p>
            <p>
            ...
            <p className="uppercase pt-6">Interactions with Other Users</p>
            <p>
            ...
            <p className="uppercase pt-6">Online Postings</p>
            <p>
            ...
            <p className="uppercase pt-6">Third-Party Advertisers</p>
            <p>
            ...
            <p className="uppercase pt-6">Affiliates</p>
            <p>
            ...
            <p className="uppercase pt-6">Business Partners</p>
            <p>
              We may share your information with our business partners to offer
              you certain products, services or promotions.
            </p>
            <p className="uppercase pt-6">Offer Wall</p>
            <p>
            ...
            <p className="uppercase pt-6">Social Media Contacts</p>
            <p>
            ...
            <p className="uppercase pt-6">Other Third Parties</p>
            <p>
            ...
            <p className="uppercase pt-6">Sale or Bankruptcy</p>
            <p>
            ...
            <p className="uppercase pt-6">Internet-Based Advertising</p>
            <p>
            ...
            <p className="uppercase pt-6">Website Analytics</p>
            <p>
              ...
              to, among other things, analyze and track users' use of the
              Application, determine the popularity of certain content, and
            ...
            <p>
              ...
              these links to leave the Application, any information you provide
              to these third parties is not covered by this Privacy Policy, and
            ...
            <p className="uppercase pt-6">Emails and Communications</p>
            <p>
