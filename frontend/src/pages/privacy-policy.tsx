  ...
  return (
    <>
      ...
      <div className="text-justify">
        ...
        <p>
          When you purchase something from our Site, as part of the buying and
          selling process, we collect the personal information you give us such
          as your name, address and email address. When you browse our Site, we
        ...
        <p>
          When you click on links on our Site, they may direct you away from our
