...
export const getStaticProps: GetStaticProps = async (context) => {
  ...
  const result = await fetch("http://backend:3001/api/home/contact", {
    headers: {
          ...
          <div className="w-full flex flex-row flex-wrap items-center justify-center pt-8">
            <div className="w-1/4 flex flex-col items-center justify-start mb-6">
              <a target="_blank" href={`mailto:${props.data.contact_email}`}>
                ...
                <div className="pt-2 uppercase font-serif">Email</div>
              </a>
            </div>
            <div className="w-1/4 flex flex-col items-center justify-start mb-6">
              <a
              ...
              >
                ...
                <div className="pt-2 uppercase font-serif">WhatApp</div>
              </a>
            </div>
            <div className="w-1/4 flex flex-col items-center justify-start mb-6">
              <a target="_blank" href={props.data.contact_linkedin_url}>
                ...
                <div className="pt-2 uppercase font-serif">LinkedIn</div>
              </a>
            </div>
            <div className="w-1/4 flex flex-col items-center justify-start mb-6">
              <a target="_blank" href={props.data.contact_calendly_url}>
                ...
                <div className="pt-2 uppercase font-serif">Zoom</div>
              </a>
            </div>
          </div>
        </div>
